...
[[extra.mentors]]
name = "Alex Read"
avatar = "alex-read.webp"
avatar_alt = "Alex Read"
bio = "Alex is a Deployed AI Engineer at Helsing, working on Lura, Helsing's AI-powered acoustic analysis and anti-submarine warfare capability, and helping build SG-1, Helsing's first underwater glider.<br/><br/>Previously the founding engineer at an AI legal-tech startup, and before that building backend systems for a drone-based IMSI catcher, Alex's first encounter with Rust came while building out a RAG pipeline for the startup's AI agent. Since joining Helsing, it has become his daily driver, and he enjoys deepening his expertise by tinkering on projects in his own time."
...
[extra]
  ...
  ogimage = "/images/workshops/og-images/og-image-rust-in-action.webp"
  heroimage = "/images/workshops/rust-in-action.webp"
