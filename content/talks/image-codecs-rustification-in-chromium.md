...
[extra]
  ...
  description = "Modern browsers decode untrusted image data billions of times per day. Formats like PNG, BMP, ICO, and JPEG are parsed automatically when loading web pages, emails, or previews—making image codecs one of the most security‑critical components in the browser stack.
