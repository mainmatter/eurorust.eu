...
[extra]
  ...
  description = "Rust's ecosystem is growing fast, with exciting native options for graphical user interfaces (GUIs) emerging. Meanwhile, in the C++ universe, Qt remains one of the most established cross-platform UI frameworks, backed by decades of development and millions of users. If only it were written in Rust!
